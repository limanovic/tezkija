...
# The shipped copies: app.json points at assets/images/.
cp app-icon-1024.png            ../../assets/images/icon.png
cp android-icon-foreground.png  ../../assets/images/android-icon-foreground.png
cp android-icon-monochrome.png  ../../assets/images/android-icon-monochrome.png
cp splash-icon.png              ../../assets/images/splash-icon.png
echo "copied into assets/images/"
